<template>
  <main class="page">
    ...
    <div v-if="(!pagePassword || pageDescrypted) && commentEnable" :delay="0.16">
         <div  v-if="(!pagePassword || pageDescrypted) && commentEnable"  class="valine-wrapper" id="SOHUCS" :sid="$route.path" />
    </div>
